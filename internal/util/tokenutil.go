...
// ModelBudget holds the model capacity fields that tokenutil needs for
// budget calculations. It is a minimal view of the root-level ModelInfo.
...
func MaxInputTokens(info *ModelBudget) int64 {
