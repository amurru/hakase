...
func TestMaxInputTokens(t *testing.T) {
	...
	info := &ModelBudget{ContextWindow: 100_000, MaxInputTokens: 80_000}
	...
	if got := MaxInputTokens(&ModelBudget{}); got != 0 {
