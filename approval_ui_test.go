...
func TestApprovalUIPromptMsgSetsPendingApproval(t *testing.T) {
	...
	req := ApprovalRequest{Tool: "system_exec", Command: "rm -rf /", Risk: "HIGH", Reason: "destructive"}
...
func TestApprovalUIKeyYApproves(t *testing.T) {
	...
	m.pendingApproval = &approvalPromptMsg{
		Req:  ApprovalRequest{Tool: "system_exec", Command: "ls", Risk: "LOW", Reason: "test"},
		Resp: resp,
	}
...
func TestApprovalUIKeyNDenies(t *testing.T) {
	...
	resp := make(chan bool, 1)
	m.pendingApproval = &approvalPromptMsg{
		Req:  ApprovalRequest{Tool: "system_exec", Command: "rm -rf /", Risk: "HIGH", Reason: "test"},
		Resp: resp,
	}
...
func TestApprovalUIEscDenies(t *testing.T) {
	...
	resp := make(chan bool, 1)
	m.pendingApproval = &approvalPromptMsg{
		Req:  ApprovalRequest{Tool: "system_exec", Command: "dd if=/dev/zero of=/dev/sda", Risk: "HIGH", Reason: "raw device"},
		Resp: resp,
	}
