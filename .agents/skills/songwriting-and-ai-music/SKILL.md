...
description: 'Songwriting craft and Suno AI music prompting. Use when the user asks to write song lyrics, create a Suno music prompt, write a parody song, adapt existing lyrics, or generate AI music with structure tags and metatags.'
license: MIT
metadata:
  author: 'hakase (ported from Hermes Agent; original Hermes creation, MIT)'
  version: 1.0.0
  source: https://github.com/NousResearch/hermes-agent/tree/main/skills/creative/songwriting-and-ai-music
---
...
> **Note:** This skill is pure doctrine — it teaches songwriting craft and Suno AI
> prompt engineering. Music generation itself is external (Suno web product at
> suno.com — paste prompts manually). hakase has no native TTS or audio generation tools.
...
8. **Paste into Suno (suno.com)** — generate 3-5 variations minimum; treat them like recording takes
...
*Ported to hakase from [Hermes Agent](https://github.com/NousResearch/hermes-agent) (MIT). Original Hermes Agent creation (MIT). Generation is external: Suno (suno.com) - not part of this skill.*
