---
name: humanizer
description: 'Humanize text by stripping AI-isms and adding real voice. Use when the user asks to humanize, de-AI, de-slop, or un-ChatGPT text; rewrite to sound natural and not LLM-generated; edit drafts (blog posts, essays, PR descriptions, docs, memos, emails, tweets, resume bullets) to match personal voice; or review writing for AI tells before publishing.'
license: MIT
metadata:
  author: 'hakase (ported via Hermes Agent; original: Siqi Chen (blader) / blader/humanizer, MIT)'
  version: 1.0.0
  source: https://github.com/NousResearch/hermes-agent/tree/main/skills/creative/humanizer
---
...
Also apply this skill to **your own** output when writing user-facing prose such as release notes, PR descriptions, docs, and summaries. hakase's baseline voice already strips most of these, but a focused pass catches what slips through.

## How to use it in hakase
