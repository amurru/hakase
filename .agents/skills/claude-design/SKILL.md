---
name: claude-design
description: 'Design one-off HTML artifacts (landing pages, decks, prototypes, motion studies) with surface-first composition and slop diagnostics. Use when the user asks for design work, a landing page, prototype, slide deck, component exploration, dashboard concept, or any UI artifact as a self-contained HTML file. Also use for interactive mockups, visual option boards, and onboarding flows.'
license: MIT
metadata:
  author: 'hakase (ported via Hermes Agent; original Hermes skill by BadTechBandit, MIT)'
  version: 1.0.0
  source: https://github.com/NousResearch/hermes-agent/tree/main/skills/creative/claude-design
---
...
hakase has three design-related skills under `skills/creative/`. They do different jobs -- load the right one (or combine them):
...
For 1920x1080 slide decks, text should generally be 24px or larger.
...
Default slide size: 1920x1080, 16:9.
...
3. **Feature-tile grid** -- icon + heading + sentence x 3, all equal weight, nothing prioritized.
...
*Ported to hakase from [Hermes Agent](https://github.com/NousResearch/hermes-agent) (MIT). Original: Hermes Agent creative skill by BadTechBandit (MIT), adapted from the hosted Claude Design design process/taste (Anthropic).*
