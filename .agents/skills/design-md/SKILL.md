...
license: MIT
metadata:
  author: 'hakase (ported via Hermes Agent; skill by Hermes Agent, tool by Google / google-labs-code/design.md, Apache-2.0)'
  version: 1.0.0
  source: https://github.com/NousResearch/hermes-agent/tree/main/skills/creative/design-md
---
...
*Ported to hakase from [Hermes Agent](https://github.com/NousResearch/hermes-agent) (MIT). Skill by Hermes Agent (MIT). Underlying spec/tool: [google-labs-code/design.md](https://github.com/google-labs-code/design.md) by Google (Apache-2.0).*
